...
<div class="page-container">
    <div class="container-fluid">
        <div class="row m-t-30">
            <div class="col">
                <div class="title" style="margin-top: 40px; margin-bottom: 15px">Sales graph:</div>
            </div>
                    ...
                    <div class="row form-group d-flex justify-content-center align-items-center">
                        <div class="col">
                            <div class="d-flex justify-content-center">
                                <button
                                        class="btn btn-lg background-marine color-white" id="calculateButton"
                                        value="calculateButton"
            ...
            if ($count > 0) {
                ...
                foreach ($orders as $current) {
                    ...
                    array_walk_recursive($current, function ($value, $key) use ($or) {
